...
NOISE_SUBJECTS = ["accepted:","declined:","tentative:","canceled:","cancelled:","your teams meeting recording","messages in quarantine","build your first","free trial","earn a free night","verify a new device","security information has been updated","new login from","your ride with","merci d'avoir","your trial ends","complete your","reminder: complete","take off for less","don't wait","every second counts","weekly round-up","weekend briefing","flight prices","pack your bags","upgrade to premium","last chance:","featured project","voting is now open","tell us more about","this stock is up","programming era","grid fragility","just killed","just requested to connect","posted new notes","smoother pickups","100+ ai use cases","see you next week at","your microsoft invoice","shared a file with you","invited you to edit","has been deleted","recording has expired","synced invitation:","updated invitation:","canceled event:","cancelled event:","invitation:","synced invitation","updated invitation","canceled event","cancelled event","meeting forward notification:"]
