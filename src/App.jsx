...
// ═══════════════════════════════════════════════════════════
const HIST = [
  { id: "h0", score: 10, label: "CRITICAL", tier: "PIPELINE [18MW]", pattern: "A", stage: "dave", from: "John Hall", company: "TechRE Consulting", email: "john.hall@techreconsulting.com", subject: "TechRE Introducer \u2014 18MW AI Prospect for Redhill", time: "Mar 4", date: "2026-03-04", link: "#", jarvis: "18MW IT load, 144 racks at 120kW, AAA client, GPUs on order. Q2 2027 deadline. TechRE introducer at 10% commission.", action: "Confirm 18MW feasibility. Connect substation contractors.", reply: "John,\n\nEngineering team accelerating assessment.\n\nBest,\nDave", deal: "Redhill 18MW", dealValue: "\u00A342M", actions: ["Call John", "Forward to Ash", "Request Feasibility", "Defer 48h"], primaryAction: "Call John", reasons: ["Pipeline: john hall", "KW: MW, rack"], att: false, ai: false, read: true, threads: 8, avatar: "JH", color: "#6366f1" },
  { id: "d1", score: 9, label: "CRITICAL", tier: "TIER 1", pattern: "G", stage: "dave", from: "Jamie Thirlwall", company: "Castleforge Partners", email: "jamie.thirlwall@castleforge.com", subject: "Monthly Deck for March Business Review", time: "Mar 17, 8:25 PM", date: "2026-03-17", link: "#", jarvis: "Final monthly report for board meeting. Full leadership on thread.", action: "Review deck TONIGHT.", reply: "Jamie,\n\nReceived, reviewing tonight.\n\nBest,\nDave", deal: "Castleforge JV", dealValue: "Board", actions: ["Review Now", "Delegate to France", "Request Changes"], primaryAction: "Review Now", reasons: ["Tier 1: castleforge.com", "KW: board"], att: true, ai: false, read: true, threads: 5, avatar: "JT", color: "#0ea5e9" },
  { id: "d2", score: 9, label: "CRITICAL", tier: "PIPELINE VIP", pattern: "D", stage: "dave", from: "John Hall", company: "TechRE Consulting", email: "john.hall@techreconsulting.com", subject: "Re: Redhill Unit 1&2 optionality", time: "Mar 17, 4:41 PM", date: "2026-03-17", link: "#", jarvis: "John reviewing high-density positioning for Redhill Units 1&2. 18MW prospect thread.", action: "Follow up Friday if no response.", reply: "", deal: "Redhill 18MW", dealValue: "\u00A342M", actions: ["Follow Up", "Call John", "Forward to Ashley"], primaryAction: "Follow Up", reasons: ["Pipeline: john hall", "KW: redhill"], att: false, ai: false, read: true, threads: 12, avatar: "JH", color: "#6366f1" },
  { id: "h12", score: 9, label: "CRITICAL", tier: "DAVE FLAGGED", pattern: "A", stage: "dave", from: "Fiona Leon", company: "Digital Realty", email: "fiona.leon@drt.co.uk", subject: "Galaxy / DRT Partnership & Cloud House \u2014 TOP PRIORITY", time: "Jan 13", date: "2026-01-13", link: "", jarvis: "DRT Partnership for Cloud House. Dave: 'TOP PRIORITY.' Zayo connectivity in progress.", action: "Re-engage. Still TOP PRIORITY.", reply: "", deal: "DRT Cloud House", dealValue: "Strategic", actions: ["Call Fiona", "Email Louise", "Delegate"], primaryAction: "Call Fiona", reasons: ["Tier 2: drt.co.uk", "Dave flagged"], att: false, ai: false, read: true, threads: 6, avatar: "FL", color: "#8b5cf6" },
  { id: "d4", score: 8, label: "URGENT", tier: "INTERNAL VIP", pattern: "D", stage: "dave", from: "Ashley Roberts", company: "Galaxy Data Centers", email: "ashley@galaxydatacenters.com", subject: "Redhill High Density Strategy for Castleforge", time: "Mar 17, 5:14 PM", date: "2026-03-17", link: "#", jarvis: "High-density strategy commentary to Pelle Jorgen at Castleforge.", action: "Review before board meeting.", reply: "", deal: "Castleforge JV", dealValue: "", actions: ["Review & Approve", "Request Changes", "Forward to Paul"], primaryAction: "Review & Approve", reasons: ["Internal VIP", "8 VIPs on thread"], att: false, ai: false, read: false, threads: 4, avatar: "AR", color: "#14b8a6" },
  { id: "d6", score: 7, label: "URGENT", tier: "INTERNAL VIP", pattern: "G", stage: "dave", from: "Paul Leong", company: "Galaxy Data Centers", email: "paul@galaxydatacenters.com", subject: "High Density Commentary \u2014 run by Pelle", time: "Mar 17, 4:00 PM", date: "2026-03-17", link: "#", jarvis: "Paul suggests adding comparison table before sending to Castleforge.", action: "Add high vs low density table.", reply: "", deal: "Castleforge JV", dealValue: "", actions: ["Add Table", "Approve As-Is", "Discuss"], primaryAction: "Add Table", reasons: ["Internal VIP", "Dave in thread"], att: false, ai: false, read: false, threads: 3, avatar: "PL", color: "#f59e0b" },
  { id: "d3", score: 8, label: "URGENT", tier: "TIER 1", pattern: "G", stage: "france", from: "Jamie Thirlwall", company: "Castleforge Partners", email: "jamie.thirlwall@castleforge.com", subject: "Board Deck slides received", time: "Mar 17, 8:09 PM", date: "2026-03-17", link: "#", jarvis: "All slides received. Finalizing pack tonight.", action: "FYI \u2014 being finalized.", reply: "", deal: "Castleforge JV", dealValue: "", actions: ["Acknowledge", "Follow Up"], primaryAction: "Acknowledge", reasons: ["Tier 1: castleforge.com"], att: false, ai: false, read: true, threads: 2, avatar: "JT", color: "#0ea5e9" },
  { id: "d9", score: 6, label: "IMPORTANT", tier: "INTERNAL VIP", pattern: "E", stage: "france", from: "Ashley Roberts", company: "Galaxy Data Centers", email: "ashley@galaxydatacenters.com", subject: "Partner Agreement sent to Mark", time: "Mar 17, 6:33 PM", date: "2026-03-17", link: "#", jarvis: "Partner agreement forwarded to Mark Vecchiarelli.", action: "Monitor for Mark's response.", reply: "", deal: "Partner Agreement", dealValue: "", actions: ["Monitor", "Follow Up"], primaryAction: "Monitor", reasons: ["Internal VIP", "KW: contract"], att: true, ai: false, read: true, threads: 2, avatar: "AR", color: "#14b8a6" },
  { id: "d10", score: 6, label: "IMPORTANT", tier: "INTERNAL VIP", pattern: "G", stage: "france", from: "Sai Raman", company: "Galaxy Data Centers", email: "sai@galaxydatacenters.com", subject: "246 London BFSI prospects", time: "Mar 17, 6:58 PM", date: "2026-03-17", link: "#", jarvis: "246 London financial services prospect list.", action: "Review list quality.", reply: "", deal: "Lead Gen", dealValue: "246 prospects", actions: ["Review List", "Forward to Paul", "Archive"], primaryAction: "Review List", reasons: ["Internal VIP", "Attachments"], att: true, ai: false, read: true, threads: 1, avatar: "SR", color: "#6366f1" },
  { id: "d7", score: 7, label: "URGENT", tier: "REDHILL OPS", pattern: "I", stage: "complete", from: "Benjamin Tyson", company: "Redhill Data Centre", email: "benjamin.tyson@redhilldatacentre.com", subject: "Rivington Energy Tour confirmed", time: "Mar 17, 2:44 PM", date: "2026-03-17", link: "#", jarvis: "Tour booked. Colin Bell confirmed.", action: "Done.", reply: "", deal: "Redhill Ops", dealValue: "", actions: [], primaryAction: "", reasons: ["Redhill ops"], att: false, ai: false, read: true, threads: 1, avatar: "BT", color: "#10b981" },
];
...
function Dashboard() {
  ...
  return (
    <div style={{ height: "100vh", width: "100vw", background: T.bg, fontFamily: "'Inter',system-ui,sans-serif", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      {/* HEADER */}
      <div style={{ background: T.surface, borderBottom: `1px solid ${T.border}`, padding: "0 28px", height: 56, display: "flex", alignItems: "center", flexShrink: 0, gap: 20 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ width: 28, height: 28, borderRadius: 7, background: "linear-gradient(135deg,#6366f1,#8b5cf6)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 800, color: "#fff" }}>J</div>
          <span style={{ fontSize: 14, fontWeight: 600, color: T.text }}>JARVIS</span>
          <span style={{ fontSize: 13, color: T.textDim }}>/ {page === "queue" ? (role === "dave" ? "Dave's Queue" : role === "france" ? "France's Queue" : "All Items") : "All Emails"}</span>
        </div>
        {/* Page tabs */}
          ...
          <div style={{ maxWidth: 740 }}>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <p style={{ fontSize: 14, color: T.textMid, margin: 0, lineHeight: 1.6 }}>
                Jarvis has triaged your inbox. {filtered.length} item{filtered.length !== 1 ? "s" : ""} need{filtered.length === 1 ? "s" : ""} your decision
                {critCount > 0 ? ` \u2014 ${critCount} ${critCount === 1 ? "is" : "are"} time-critical` : ""}.
              </p>
            </div>
...
function AllEmailsPage({ data, upd, mob }) {
  ...
  const u = sel ? (URG[sel.label] || URG.NOTABLE) : URG.NOTABLE;
  ...
  return (
    <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
      {/* LEFT — Email List */}
      {!(mob && mobDetail) && (
        <div style={{ width: mob ? "100%" : 440, borderRight: mob ? "none" : `1px solid ${T.border}`, display: "flex", flexDirection: "column", background: T.bg }}>
          {/* Search + Filters */}
          <div style={{ padding: "12px 16px", borderBottom: `1px solid ${T.border}`, display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            <div style={{ display: "flex", gap: 4, flexWrap: "wrap", alignItems: "center" }}>
              {["ALL", "CRITICAL", "URGENT", "IMPORTANT", "NOTABLE"].map(f => (
                <button key={f} onClick={() => setUrgFilter(f)} style={{
                  fontSize: 10, padding: "4px 10px", borderRadius: 5, cursor: "pointer", fontFamily: "inherit", fontWeight: urgFilter === f ? 700 : 400,
                  border: urgFilter === f ? `1px solid ${f === "ALL" ? T.accent : (URG[f]?.bar || T.muted)}40` : `1px solid ${T.border}`,
                  background: urgFilter === f ? (f === "ALL" ? T.accentLight : (URG[f]?.badge || T.mutedBg)) : T.surface,
                  color: urgFilter === f ? (f === "ALL" ? T.accent : (URG[f]?.text || T.textMid)) : T.textDim,
                }}>{f === "ALL" ? "All" : f}</button>
              ))}
              <div style={{ marginLeft: "auto" }}>
                <button onClick={() => setShowDone(!showDone)} style={{ fontSize: 10, padding: "4px 10px", borderRadius: 5, border: `1px solid ${showDone ? T.green + "40" : T.border}`, background: showDone ? T.greenBg : T.surface, color: showDone ? T.greenText : T.textDim, cursor: "pointer", fontFamily: "inherit" }}>
            ...
            <div style={{ display: "flex", gap: 4, flexWrap: "wrap" }}>
              {STAGES.filter(s => s.id !== "complete").map(s => (
                <button key={s.id} onClick={() => setStageFilter(stageFilter === s.id ? "ALL" : s.id)} style={{
                  ...
                  border: `1px solid ${stageFilter === s.id ? s.c + "40" : T.border}`,
                  background: stageFilter === s.id ? `${s.c}10` : T.surface,
                  color: stageFilter === s.id ? s.c : T.textDim,
                }}>{s.label} ({data.filter(e => e.stage === s.id).length})</button>
              ))}
            </div>
          </div>
          {/* List */}
          <div style={{ flex: 1, overflowY: "auto" }}>
            <div style={{ padding: "6px 16px", fontSize: 10, fontWeight: 600, color: T.textDim, letterSpacing: .6, textTransform: "uppercase", background: T.surface, borderBottom: `1px solid ${T.border}` }}>
              {filtered.length} email{filtered.length !== 1 ? "s" : ""}
            </div>
            {filtered.map((e, i) => {
              const eu = URG[e.label] || URG.NOTABLE;
              ...
              return (
                <div key={e.id} onClick={() => { setSelId(e.id); if (mob) setMobDetail(true); }} style={{
                  ...
                  borderLeft: `3px solid ${isSel ? eu.bar : "transparent"}`,
                  background: isSel ? T.surface : "transparent",
                  opacity: e.stage === "complete" ? 0.5 : 1, transition: "all 150ms",
                }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }}>
                    {/* Score */}
                    <div style={{ width: 30, height: 30, borderRadius: 8, background: eu.badge, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, fontWeight: 700, color: eu.text, flexShrink: 0 }}>{e.score}</div>
                    {/* Avatar */}
                    <div style={{ width: 30, height: 30, borderRadius: 8, background: (e.color || T.accent) + "18", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 9, fontWeight: 700, color: e.color || T.accent, border: `1px solid ${(e.color || T.accent)}25`, flexShrink: 0 }}>{e.avatar || "?"}</div>
                    <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 2, flexShrink: 0 }}>
                      <span style={{ fontSize: 9, fontWeight: 700, color: eu.text, background: eu.badge, padding: "2px 6px", borderRadius: 4 }}>{e.label}</span>
                      <span style={{ fontSize: 10, color: T.textDim }}>{e.time}</span>
                    </div>
                  </div>
                  <div style={{ fontSize: 13, fontWeight: 500, color: T.text, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", marginLeft: 70, marginBottom: 4 }}>{e.subject}</div>
                  <div style={{ display: "flex", gap: 4, alignItems: "center", marginLeft: 70 }}>
                    ...
                    {e.att && <span style={{ fontSize: 9, color: T.teal, background: T.tealBg, padding: "1px 5px", borderRadius: 3 }}>ATT</span>}
                    {e.ai && <span style={{ fontSize: 9, color: T.accent, background: T.accentLight, padding: "1px 5px", borderRadius: 3 }}>AI</span>}
                    {!e.read && <span style={{ width: 6, height: 6, borderRadius: "50%", background: T.accent }} />}
                  </div>
                </div>
              );
            })}
        ...
        <div style={{ flex: 1, overflowY: "auto", background: T.surface }}>
          {sel ? (
            <div style={{ padding: mob ? 20 : 28, maxWidth: 720 }}>
              {mob && <button onClick={() => setMobDetail(false)} style={{ marginBottom: 12, padding: "6px 14px", background: T.bg, border: `1px solid ${T.border}`, color: T.accent, borderRadius: 7, fontSize: 12, cursor: "pointer", fontFamily: "inherit", fontWeight: 600 }}>{"\u2190"} Back</button>}
              {/* Header card */}
              <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 16, padding: 16, background: T.bg, borderRadius: 12, border: `1px solid ${T.border}` }}>
                <div style={{ width: 48, height: 48, borderRadius: 10, background: u.badge, border: `2px solid ${u.bar}40`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                  <span style={{ fontSize: 20, fontWeight: 700, color: u.text }}>{sel.score}</span>
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <span style={{ fontSize: 10, fontWeight: 700, color: u.text, background: u.badge, padding: "3px 10px", borderRadius: 5 }}>{u.label}</span>
              </div>

              {/* Outlook link */}
              {sel.link && sel.link !== "#" && sel.link !== "" && <a href={sel.link} target="_blank" rel="noopener noreferrer" style={{ display: "block", padding: "10px 0", marginBottom: 14, background: "linear-gradient(135deg,#6366f1,#8b5cf6)", color: "#fff", borderRadius: 8, fontSize: 13, fontWeight: 600, textDecoration: "none", textAlign: "center", fontFamily: "inherit" }}>Open in Outlook {"\u2197"}</a>}

              {/* Subject */}
              <div style={{ fontSize: 18, fontWeight: 700, marginBottom: 12, lineHeight: 1.3 }}>{sel.subject}</div>

              {/* Tags */}
              <div style={{ display: "flex", gap: 6, marginBottom: 14, flexWrap: "wrap" }}>
                <span style={{ fontSize: 10, padding: "3px 10px", borderRadius: 5, background: u.badge, border: `1px solid ${u.bar}20`, color: u.text, fontWeight: 700 }}>{sel.label}</span>
                {sel.pattern && <span style={{ fontSize: 10, padding: "3px 10px", borderRadius: 5, background: T.bg, color: T.textMid }}>{PAT[sel.pattern] || sel.pattern}</span>}
                <span style={{ fontSize: 10, padding: "3px 10px", borderRadius: 5, background: T.bg, color: T.textMid }}>{sel.tier}</span>
                {sel.att && <span style={{ fontSize: 10, padding: "3px 10px", borderRadius: 5, background: T.tealBg, color: T.tealText }}>Attachment</span>}
                {sel.ai && <span style={{ fontSize: 10, padding: "3px 10px", borderRadius: 5, background: T.accentLight, color: T.accent }}>AI Reviewed</span>}
                {sel.deal && <span style={{ fontSize: 10, padding: "3px 10px", borderRadius: 5, background: T.accentLight, color: T.accent }}>{sel.deal}</span>}
              </div>
              ...
              <div style={{ marginBottom: 16 }}>
                <div style={{ fontSize: 10, color: T.textDim, fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", marginBottom: 6 }}>Assign to</div>
                <div style={{ display: "grid", gridTemplateColumns: mob ? "repeat(3,1fr)" : "repeat(6,1fr)", gap: 6 }}>
                  {STAGES.map(s => (
                    <button key={s.id} onClick={() => upd(sel.id, s.id)} style={{
                      padding: "8px 0", background: sel.stage === s.id ? `${s.c}10` : T.bg,
                      border: `1px solid ${sel.stage === s.id ? s.c + "40" : T.border}`, color: sel.stage === s.id ? s.c : T.textDim,
                      borderRadius: 7, fontSize: 11, cursor: "pointer", fontFamily: "inherit", textAlign: "center",
                    }}>{s.label}</button>
                  ))}
                </div>
              </div>
              ...
              {/* JARVIS briefing */}
              {sel.jarvis && (
                <div style={{ marginBottom: 14, padding: "14px 16px", background: T.accentLight, borderRadius: 10, border: `1px solid ${T.accentBorder}` }}>
                  <div style={{ fontSize: 10, fontWeight: 700, color: T.accent, marginBottom: 7, letterSpacing: .5 }}>JARVIS SAYS</div>
                  <p style={{ fontSize: 13.5, color: T.accentText, lineHeight: 1.65, margin: 0 }}>{sel.jarvis}</p>
                </div>
              )}

              {/* Recommended action */}
              {sel.action && (
                <div style={{ marginBottom: 14, padding: "12px 16px", background: u.badge, borderRadius: 10, border: `1px solid ${u.bar}20` }}>
                  <div style={{ fontSize: 10, fontWeight: 700, color: u.text, marginBottom: 5, letterSpacing: .5 }}>RECOMMENDED ACTION</div>
                  <div style={{ fontSize: 13, color: u.text, fontWeight: 500, lineHeight: 1.5 }}>{sel.action}</div>
                </div>
              )}

              {/* Draft reply */}
              {sel.reply && (
                <div style={{ marginBottom: 14, padding: "12px 14px", background: T.bg, borderRadius: 8, border: `1px solid ${T.border}` }}>
                  <div style={{ fontSize: 10, fontWeight: 600, color: T.textDim, marginBottom: 6, letterSpacing: .5 }}>DRAFT REPLY</div>
                  <pre style={{ fontSize: 12, color: T.textMid, lineHeight: 1.6, margin: 0, whiteSpace: "pre-wrap", fontFamily: "inherit" }}>{sel.reply}</pre>
                  <div style={{ display: "flex", gap: 6, marginTop: 8 }}>
                    <button onClick={() => navigator.clipboard?.writeText(sel.reply)} style={{ padding: "6px 14px", borderRadius: 6, border: `1px solid ${T.border}`, background: T.surface, color: T.accent, fontSize: 11, fontWeight: 600, cursor: "pointer", fontFamily: "inherit" }}>Copy as Dave</button>
